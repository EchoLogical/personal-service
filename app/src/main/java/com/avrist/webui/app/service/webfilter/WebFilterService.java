package com.avrist.webui.app.service.webfilter;

import com.avrist.webui.app.service.BusinessService;
import com.avrist.webui.app.service.webfilter.helper.RouteFilterHelper;
...
public class WebFilterService implements BusinessService<WebFilterInput, Boolean> {
    ...
    @Override
    public Boolean execute(WebFilterInput input) throws BusinessServiceValidationException {
        // for public access
