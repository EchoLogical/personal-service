...
import com.github.echological.sc.datasource.gateway.constant.GatewayDSConstant;
...
@EnableJpaRepositories(
        basePackages = GatewayDSConstant.REPO_PACKAGE,
...
public class GatewayDatasourceConfig {
    ...
    private String prop(String key){
        return env.getProperty(String.format(GatewayDSConstant.PROP, key));
    }
    ...
    public LocalContainerEntityManagerFactoryBean gatewayEntityManager(){
        ...
        em.setPackagesToScan((GatewayDSConstant.ENTITY_PACKAGE));
