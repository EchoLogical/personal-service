package com.avrist.webui.endpoint.logger.bizservice.eventcallback.controller;

import com.avrist.webui.global.exception.BusinessServiceValidationException;
import com.avrist.webui.endpoint.logger.bizservice.eventcallback.EventCallbackService;
import com.avrist.webui.endpoint.logger.bizservice.eventcallback.model.request.EventCallbackRequest;
import com.avrist.webui.endpoint.logger.bizservice.eventcallback.model.response.EventCallbackResponse;
